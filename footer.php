        ...
        <div class="foot-uper">
            <div class="col-1">
                ...
                <div class="socials">
                    ...
                    <a href="whatsapp"><i class="ri-whatsapp-fill"></i></a>
            ...
            <div class="col-2">
                ...
                <div class="footer-menu">
                    ...
                    <li><a href="#">Tips de mascotas</a></li>
                </div>
            </div>
            <div class="col-3">
                ...
                <div class="icon-list">
                    ...
                    <li><a href="Patitas a casa@gmail.com"><i class="ri-mail-fill"></i> Patitasacasa@gmail.com</a></li>
                    <li><a href="#"><i class="ri-map-pin-fill"></i> ESCOM, CDMX</a></li>
                </div>
            </div>
        </div>
        <div class="foot-lower">
            <p>Copyright © 2024 <span><a href="./index.php" style="color:#202020; text-decoration:none">Patitas a casa.</a> </span>Todos los derechos reservados</p>
        </div>
