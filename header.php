...
<nav >
        <div class="left-nav">
            <a href="index.php" class="logo"><img src="images/logos/logoPatitas.png" alt=""></a>
        </div>
        <div class="menu menu-close">
            ...
            <ul id="navMenus" class="w-nav-link">
                ...
                <li><a class="<?php echo $current_page == 'about-us.php' ? 'active':NULL ?>" href="about-us.php">Sobre nosotros</a></li>
                <li><a class="<?php echo $current_page == 'lost-pet.php' ? 'active':NULL ?>" href="lost-pet.php">Perdi a mi mascota</a></li>
        <li><a class="<?php echo $current_page == 'found-pet.php' ? 'active':NULL ?>" href="found-pet.php">Encontré mascota</a></li>
                <li><a class="<?php echo $current_page == 'contact-us.php' ? 'active':NULL ?>" href="contact-us.php">Contacto</a></li>
