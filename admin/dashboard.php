...
<head>
    ...
    <title>Admin Dashboard | Patitas empolvadas</title>
        ...
        <div id="dash">
            <div class="dash-left">
                ...
                <ul class="nav">
                    ...
                    <li><a href="lost-pets.php">Mascotas perdidas</a></li>
                </ul>
                <a href="logout.php " class="btn-primary">Salir</a>
            </div>
            <div class="dash-right">
                <h1 class="single-title">Panel</h1>
                <div class="dash-nums">
                    <div class="item">
                ...
                <div class="dash-item text-center">
                    ...
                    <a href="found-pets.php" class="btn-small " >Ver mas...</a>
                </div>
                <div class="dash-item text-center">
                    <h3 class="text-center">Mascotas perdidas</h3>
                    <div>
                        <?php
